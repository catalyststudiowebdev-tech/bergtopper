...
export function VerticalQHero() {
  return (
    <section id="intro" className="bt-section-shell relative flex min-h-[72vh] flex-col bg-surface-warm sm:min-h-[80vh]">
      <div aria-hidden="true" className="absolute inset-0">
        <Image
          src="/verticalq_mountains.jpeg"
          alt=""
          fill
          priority
          sizes="100vw"
        ...
        <Container className="pb-24 pt-20 sm:pb-32 sm:pt-28">
          <div className="max-w-2xl">
            <h1 className="bt-enter font-display text-4xl leading-[1.08] tracking-tight text-foreground sm:text-6xl lg:text-7xl">
              Van IQ naar VQ:
              <br />
              <span>ontdek je natuurlijke</span>
              <br />
              <span style={{ color: "#8BAF72" }}>talenten.</span>
            </h1>
            ...
            <p className="bt-body bt-enter bt-enter-d1 mt-8 max-w-xl text-muted">
              ...
              Echte veranderkracht en duurzame groei ontstaan wanneer je
              begrijpt waar jouw natuurlijke kracht ligt.
            </p>
